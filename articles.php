				...
				<div class="row">
							...
							<div class="col-md-6">
								<div class="single-article">
									<div class="article-img">
										<a href="article-post.php">
											<img src="./img/course01.jpg" alt="">
										</a>
									</div>
									<h4><a href="article-post.php">Pro eu error molestie deserunt. At per viderer bonorum persecuti.</a></h4>
					...
					<div id="aside" class="col-md-3">
						...
						<div class="widget posts-widget">
							...
							<!-- single posts -->
							<div class="single-article">
								<a class="single-article-img" href="article-post.php">
									<img src="./img/post01.jpg" alt="">
								</a>
								<a href="article-post.php">Pro eu error molestie deserunt.</a>
